# Fix issue with maame throw a seg fault when initialy started
...
#PROCESSES="$(expr $(echo $(getconf _NPROCESSORS_ONLN))  )"
...
# Fix contains contains a standard runpath '/usr/lib64' in [/usr/lib64]
